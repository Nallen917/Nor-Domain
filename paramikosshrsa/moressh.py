...
def main():
    ...
    for cred in credz:
        ...
        ls_output = sessout.read().decode('utf-8')

        with open("results.log", "a") as results_file:
            results_file.write("Results from " + cred.get("un") + "@" + cred.get("ip") + ":\n")
            results_file.write(ls_output + "\n")
